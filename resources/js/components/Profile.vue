      ...
      <div class="col-md-12 mt-3">
        <div class="card card-widget widget-user">
          ...
          <div
            ...
            style="background: url('./img/logo.png') center center;"
          >
            <h3 class="widget-user-username text-right">Elizabeth Pierce</h3>
            <h5 class="widget-user-desc text-right">Web Designer</h5>
          </div>
          <div class="widget-user-image">
            <img class="img-circle" src="../../../public/img/profile.jpg" alt="User Avatar" />
          </div>
              ...
              <div class="tab-content">
                <div class="active tab-pane" id="activity">
                  ...
                  <div class="post">
                    ...
                    <div class="row mb-3">
                      <div class="col-sm-6">
                        <img class="img-fluid" src="../../../public/img/profile.jpg" alt="Photo" />
                      </div>
                      <!-- /.col -->
                      <div class="col-sm-6">
                        <div class="row">
